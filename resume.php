...
<head>
  ...
  <meta charset="UTF-8">
  <title>vCard Walid HASSANI</title>
...
<div class="bs-example">
  ...
  <div class="tab-pane" id="resume">
        ...
        <div class="col-md-7" style="margin-left:40px; margin-top:30px; margin-bottom:30px">
          <div class="timeline-section">
            <!-- Timeline for Education  -->   

            <h3><span class="glyphicon glyphicon-book" style="color:gainsboro;"> </span> EDUCATION</h3>   
            <ul class="timeline">
              <li>            
